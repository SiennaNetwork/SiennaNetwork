...
export const build = (options={}) => Ops.build(CONTRACTS, { workspace: projectRoot, ...options })

export const upload = (options={}) => Ops.upload(CONTRACTS, { workspace: projectRoot, ...options })
