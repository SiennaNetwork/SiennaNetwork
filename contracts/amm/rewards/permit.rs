...
//         let err = permit
//             .validate_with_permissions(deps, wrong_contract.clone(), permissions.clone())
//             .unwrap_err();
...
//         let err = permit
//             .validate_with_permissions(deps, contract_addr.clone(), expected_permissions.clone())
//             .unwrap_err();
...
//         let result = permit
//             .validate_with_permissions(deps, contract_addr, permissions.clone())
//             .unwrap();
